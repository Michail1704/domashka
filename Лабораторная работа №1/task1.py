...
class Cat:
    def __init__(self, name: str):
        ...
        Примеры:
        >>> cat = Cat('Барсик')  # инициализация экземпляра класса
        """
        self.name = name
...
class Box:
    def __init__(self, products: str, capacity_volume: Union[int, float], occupied_volume: Union[int, float]):
        ...
        Примеры:
        >>> box = Box('персики',500, 0)  # инициализация экземпляра класса
        """
    ...
    def add_products_to_box(self, new_product: str, volume: Union[int, float]) -> None:
        ...
        Примеры:
        >>> box = Box('персики',500, 0)
        >>> box.add_products_to_box('персики', 200)
        """
